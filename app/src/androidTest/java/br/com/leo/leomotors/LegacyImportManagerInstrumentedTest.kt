...
import br.com.leo.leomotors.data.local.migration.LegacySnapshotSource
...
class LegacyImportManagerInstrumentedTest {
    private lateinit var db: LeoMotorsDatabase

    @Before
    fun setup() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        db = Room.inMemoryDatabaseBuilder(context, LeoMotorsDatabase::class.java)
